	...
	namespace Platform {
		namespace System {
			...
			class Thread : private Implementation::Thread {
				friend class Implementation::Thread;	//Allow it to call back into CallThreadable
			public:
			...
			private:
				/*!
					@brief Properly traps and logs exceptions generated by threads
					@par Thread Safety
						This function requires no thread safety
				*/
				static void CallThreadable(API::Threadable& AThreadable) noexcept;
			public:
				/*!
