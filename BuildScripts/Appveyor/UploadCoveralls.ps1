if ($env:CONFIGURATION -eq "Debug"){
	...
	Write-Host "Downloading PathCapitalizationCorrector v0.1.3..."
	appveyor DownloadFile https://github.com/Cyberboss/PathCapitalizationCorrector/releases/download/0.1.3/PathCapitalizationCorrector.exe
