...
function(ms_parse_file SourceFile TestTarget)
  if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${SourceFile}")
    return()
  endif()
  file(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/${SourceFile}" Contents NEWLINE_CONSUME)

  # Remove block comments and *full line* comments (leave partial line comments)
  #ms_remove_block_comments(Contents) //External dep, CyberEngineMkIIITester has no block comments
