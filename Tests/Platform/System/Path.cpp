...
SCENARIO("Path Append works", "[Platform][System][Path][Unit]") {
	...
	GIVEN("A valid Path") {
		...
		WHEN("Something too long is appended onto it") {
			bool Result(false);
			REQUIRE_THROWS_AS(Result = TestPath.Append(UTF8(Static(u8"")), false, false), CYB::Exception::SystemData);
