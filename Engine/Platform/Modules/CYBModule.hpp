			...
			public:
				...
				*/
				...
				/*!
					...
					@par Thread Safety
						This function requires no thread safety
					@throws CYB::Exception::SystemData Error code: CYB::Exception::SystemData::ErrorCode::MODULE_FUNCTION_LOAD_FAILURE. Thrown if the requested function is unable to be loaded from the owned module
				*/
