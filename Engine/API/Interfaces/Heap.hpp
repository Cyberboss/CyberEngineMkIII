	...
	namespace API {
		...
		public:
			/*!
				...
				@throws CYB::Exception::Violation Error code: CYB::Exception::Violation::NEGATIVE_HEAP_ALLOCATION. Thrown if an allocation was attempted with a negative size value
			...
			*/
			...
			/*!
				...
				@par Thread Safety
					This function requires no thread safety
				@throws CYB::Exception::Violation Error code: CYB::Exception::Violation::NEGATIVE_HEAP_ALLOCATION. Thrown if an allocation was attempted with a negative size value
				@throws CYB::Exception::Violation Error code: CYB::Exception::Violation::UNSUPPORTED_ALLOCATION_AMOUNT if ANewSize is greater than or equal to 2047MB
				@throws CYB::Exception::SystemData Error code: CYB::Exception::SystemData::HEAP_ALLOCATION_FAILURE if the heap does not have the space for the allocation and more system memory cannot be requested
			*/
